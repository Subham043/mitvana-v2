...
const updateFormResetValues = (data?: ProductType) => {
  if (data) {
    return {
      ...
      features: data && data.features ? data.features : undefined,
      ...
      related_products: data && data.related_products && data.related_products.length > 0 ? data.related_products.map((item) => ({ label: item.title, value: item.id })) : [],
      ingredients: data && data.ingredients && data.ingredients.length > 0 ? data.ingredients.map((item) => ({ label: item.title, value: item.id })) : [],
      tags: data && data.tags && data.tags.length > 0 ? data.tags.map((item) => ({ label: item.name, value: item.id })) : [],
      colors: data && data.colors && data.colors.length > 0 ? data.colors.map((item) => ({ label: item.name, value: item.id })) : [],
      categories: data && data.categories && data.categories.length > 0 ? data.categories.map((item) => ({ label: item.name, value: item.id })) : [],
