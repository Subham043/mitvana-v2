...
import ProductQuickViewImageCarousel from "./ProductQuickViewImageCarousel";
import ProductQuickViewInfoSection from "./ProductQuickViewInfoSection";
...
function ProductQuickView({
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between gap-5 md:gap-10 py-10">
      <ProductQuickViewImageCarousel slides={slides} />
      <ProductQuickViewInfoSection
        title={title}
        sub_title={sub_title}
