...
import ProductQuickViewInfoVariantSection from "./ProductQuickViewInfoVariantSection";
import ProductItemInfoPriceSection from "@/app/shop/[slug]/_components/ProductInfoTopSection/ProductItemInfoSection/ProductItemInfoPriceSection";
import ProductItemInfoCartBtnSection from "@/app/shop/[slug]/_components/ProductInfoTopSection/ProductItemInfoSection/ProductItemInfoCartBtnSection";
import ProductItemInfoWishlistBtn from "@/app/shop/[slug]/_components/ProductInfoTopSection/ProductItemInfoSection/ProductItemInfoWishlistBtn";
import ProductItemInfoTitleSection from "@/app/shop/[slug]/_components/ProductInfoTopSection/ProductItemInfoSection/ProductItemInfoTitleSection";
...
function ProductQuickViewInfoSection({
  ...
  return (
    <div className="w-full md:w-1/3 leading-4">
      ...
      <ProductQuickViewInfoVariantSection child_products={child_products} />
...
export default ProductQuickViewInfoSection;
