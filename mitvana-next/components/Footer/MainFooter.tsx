      ...
      <div className="lg:grid lg:grid-cols-12 gap-2 hidden lg:block container mx-auto">
        ...
        <div className="col-span-2 text-left">
          ...
          <div className="mt-4 flex flex-col gap-3">
            ...
            <Link href="/terms-of-service" className="text-zinc-700 font-light">
              Terms & Conditions
            </Link>
            <Link href="/return-refunds" className="text-zinc-700 font-light">
              Returns & Exchanges
            </Link>
            <Link
            ...
            <Link href="/privacy-policy" className="text-zinc-700 font-light">
              Privacy Policy
            </Link>
          </div>
        </div>
