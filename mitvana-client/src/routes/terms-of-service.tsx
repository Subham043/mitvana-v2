...
function RouteComponent() {
  return (
    <div>
      <PolicyHeroSection title="Terms of Service" />
      <section className="py-10">
        <div className="container mx-auto">
          ...
          <br />
          <p>
            <span className="font-light">This website : </span>
            <span className="font-light">www.mitvana.com</span>
            <span className="font-light">
              {' '}
              &nbsp;is operated by Matxin Labs Private Limited. Throughout the
              site, the terms “we”, “us” and “our” refer to Matxin Labs Private
              Limited. Matxin Labs Private limited &nbsp;offers this website,
          ...
          <br />
          <p>
            For orders containing multiple products, delivery may occur in
            separate shipments. Typically, delivery takes 5-7 business days from
            the date the order is placed. Once your order is confirmed, you can
            view the estimated shipping and delivery timeline on the order
            details page. Please note that these estimated delivery times are
            indicative, and delays beyond our control may occur.
          </p>
          <p>
            If the company is unable to deliver your order within the estimated
            timeframe for any reason, you will be notified via email, outlining
            the cause of the delay. You will then have the option to either
            cancel the order or wait for the product to be delivered.
          </p>
          <p>
            <br />
            Please be aware that your order may be canceled in the following
            cases:{' '}
          </p>
          <br />
          <ol>
            ...
            <li>
              At your request, if the product cannot be delivered within the
              expected time frame due to delays from our delivery partners.
            </li>
          </ol>
          <p>
            The company will not be held liable for any direct or indirect
            damage or loss resulting from order cancellations or delivery
            delays.
          </p>
          <p>&nbsp;</p>
          <p>
          ...
          <p>
            <span className="font-light">
              ...
              the personal information of others; (i) to spam, phish, pretext,
              spider, crawl, or scrape; (j) for any obscene or immoral purpose;
              or (k) to interfere with or circumvent the security features of
          ...
          <p>
            <span className="font-light">
              In no case shall Matxin Labs&nbsp;Private Limted, our directors,
          ...
          <p>
            <span className="font-light">
              Only in case of any liability arising out of the usage of the
              product(s) bought from the website belonging to Matxin Labs
              Private Limited our liability will be limited to the maximum
          ...
          <p>
            <span className="font-light">
              You agree to indemnify, defend and hold harmless Matxin Labs
          ...
          <p>
            <span className="font-light">
              ...
              accordance with the laws of India and jurisdiction of Bangalore,
              Karnataka ,India
            </span>
          </p>
          <p>
          ...
          <p>
            <span className="font-light">
              ...
              <a href="mailto:info@mitvanastores.com">info@mitvanastores.com</a>
            </span>
          </p>{' '}
        </div>
      </section>
