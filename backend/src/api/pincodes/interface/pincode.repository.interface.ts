...
export interface PincodeRepositoryInterface {
    ...
    getAll(query: PaginationQuery<PincodeFilterDto>, cacheConfig?: CustomQueryCacheConfig): Promise<PincodeEntity[]>;
    count(query: CountQuery<PincodeFilterDto>, cacheConfig?: CustomQueryCacheConfig): Promise<number>
    ...
    checkPincode(code: number, cacheConfig?: CustomQueryCacheConfig): Promise<{ pincode: number; is_delivery_available: boolean; shipping_charges: number; }>;
}