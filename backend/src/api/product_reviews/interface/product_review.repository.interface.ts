...
export interface ProductReviewRepositoryInterface {
    ...
    count(query: Omit<PaginationQuery<ProductReviewFilterDto>, 'offset' | 'limit' | 'page'>, cacheConfig?: CustomQueryCacheConfig): Promise<number>
    countProductReviewsByUserId(userId: string, query: Omit<PaginationQuery<ProductReviewFilterDto>, 'offset' | 'limit' | 'page'>, cacheConfig?: CustomQueryCacheConfig): Promise<number>
    countApprovedProductReviewsByProductId(productId: string, query: Omit<PaginationQuery<ProductReviewFilterDto>, 'offset' | 'limit' | 'page'>, cacheConfig?: CustomQueryCacheConfig): Promise<number>
