...
const productUpdateSchema = vine.object({
    ...
    how_to_use: vine.string().minLength(3).optional(),
    features: vine.string().minLength(3).optional(),
    meta_description: vine.string().minLength(3).optional(),
    facebook_description: vine.string().minLength(3).optional(),
    twitter_description: vine.string().minLength(3).optional(),
    custom_script: vine.string().minLength(3).optional(),
...
export type ProductUpdateDto = Omit<Infer<typeof productUpdateSchema>, 'thumbnail' | 'images'> & { thumbnail?: MultipartFileMeta | undefined; images?: MultipartFileMeta[] }
