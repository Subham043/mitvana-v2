...
import { NewProductEntity, UpdateProductEntity, ProductQueryEntityType } from "../entity/product.entity";
...
export interface ProductRepositoryInterface {
    ...
    getAll(query: PaginationQuery): Promise<ProductQueryEntityType[]>;
