...
export interface OfferRepositoryInterface {
    getById(id: string): Promise<OfferQueryEntityType | null>;
    getAll(query: PaginationQuery<OfferFilterDto>): Promise<OfferQueryEntityType[]>;
    count(query: CountQuery<OfferFilterDto>): Promise<number>
